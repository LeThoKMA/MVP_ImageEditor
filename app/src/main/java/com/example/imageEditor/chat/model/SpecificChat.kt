...
import com.example.imageEditor.databinding.ActivitySpecificChatBinding
import com.example.imageEditor.utils.AppKey
import com.example.imageEditor.utils.convertUriToBitmap
import com.example.imageEditor.utils.getVideoFileSize
import com.example.imageEditor.utils.isVideoFile
...
class SpecificChat : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        window.statusBarColor = ContextCompat.getColor(this, com.example.imageEditor.R.color.white)
        binding = DataBindingUtil.setContentView(
            this,
            com.example.imageEditor.R.layout.activity_specific_chat
        )
